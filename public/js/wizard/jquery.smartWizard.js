...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        ...
        previous : $('<a>'+options.labelPrevious+'</a>').attr("href","#").addClass("btn btn-primary pull-left"),
        finish  : $('<a>'+options.labelFinish+'</a>').attr("href","#").addClass("btn btn-default pull-right"),
        cancel  : $('<a>'+options.labelFinish+'</a>').attr("href","#").addClass("btn btn-default pull-right")
    };
